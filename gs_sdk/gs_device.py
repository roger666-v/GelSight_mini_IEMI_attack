...
def get_camera_id(camera_name, verbose=True):
    ...
    # --- Windows OS Compatibility Fallback ---
    # Bypasses Linux-specific v4l2 directory search
    import platform
    if platform.system() == 'Windows':
        print("[INFO] Windows OS detected. Defaulting to camera ID 0.")
        # Note: Adjust to 1 or 2 if a built-in webcam is selected instead of GelSight.
        return 0
